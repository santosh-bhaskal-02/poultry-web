    ...
    <div className="flex flex-col gap-5 py-5 w-full max-w-6xl mx-auto">
      ...
      {/* <div className="fixed bottom-6 right-6 z-40">
        <Button
          ...
          className="w-14 h-14 rounded-full bg-amber-400 shadow-2xl transition-transform duration-300 hover:scale-105 hover:bg-amber-500 hover:shadow-lg focus:ring-blue-300">
